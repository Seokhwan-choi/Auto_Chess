...
Transform::Transform(const Vector2 & pos, const Vector2 & size, const Pivot::Enum & pivot)
	: mWorldPosition(pos), mLocalPosition(pos), mSize(size), mPivot(pivot),
...
**************************************************************************************/
void Transform::Move(const Vector2 & moveValue)
{
